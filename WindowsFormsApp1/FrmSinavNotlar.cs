...
namespace WindowsFormsApp1
{
    public partial class FrmSinavNotlar : Form
    {
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            //byte.Parse(comboBox1.SelectedValue.ToString()), int.Parse(Txtid.Text),byte.Parse(TxtSinav1.Text), byte.Parse(TxtSinav2.Text), byte.Parse(TxtSinav3.Text), byte.Parse(TxtProje.Text), decimal.Parse(TxtOrtalama.Text), bool.Parse(TxtDurum.Text),byte.Parse(notid.ToString())
        }
    }
}
